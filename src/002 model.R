...
rf.model.002 <- trainRangerModel(train.data, 100)  
...
rmse(log(test.data$SALANUAL),log(pred.rf.002$predictions))
# 0.4026511
#Raíz del error cuadrático medio
rmse(test.data$SALANUAL, pred.rf.002$predictions)
#Error cuadrático medio
# 26773.18
mse(test.data$SALANUAL, pred.rf.002$predictions)
# 716803003
#Error medio absoluto
mae(test.data$SALANUAL, pred.rf.002$predictions)
# 11020.32
